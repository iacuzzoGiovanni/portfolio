...
<footer class="max-w-xl mx-auto selected-work pt-8">
    <h3 class="text-xl md:text-2xl text-center mb-2 tracking-tight mb-8">Made with ❤️</h3>
    ...
    <p class="text-center text-5xl md:text-7xl tracking-tighter overflow-hidden"><span class="relative top-4 md:top-6">Giovanni Iacuzzo</span></p>
</footer>